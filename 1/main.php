    ...
    <section id="content">
        <div class="container">
            <div class="inner__content">
                <h2>ЗАРЕГИСТРИРУЙСЯ ЧТОБЫ ПОЛУЧИТЬ ДОСТУП К ПРОХОЖДЕНИЮ ОПРОСА</h2>
                <form action="sign_in.php" method="POST">
                    <input tabindex="1" type="text" name="name" placeholder="Name" autofocus><br><br>
                    <input tabindex="2" type="text" name="login" placeholder="Login "><br><br>
                    <input tabindex="3" type="password" name="password" placeholder="Password"><br><br>
                    ...
                    <button class="form-button" tabindex="4">Sign up</button>
                </form>
            </div>
        </div>
    </section>
