...
<body>
    <header>
        <div class="container">
            <a href="#" class="logo"><img src="css/img/logo2.png" alt=""></a>
            <ul class="mnu__top">
        ...
        <div class="container">
            <div class="inner__content">
                ...
                <form action="add.php" method="POST">
                    ...
                    <!-- <input tabindex="4" type="text" name="country" placeholder="Country" ><br><br> -->
                    ...
                    <button class="form-button" tabindex="3" >Sign up</button>
                </form>
            </div>
        </div>
    </section>
